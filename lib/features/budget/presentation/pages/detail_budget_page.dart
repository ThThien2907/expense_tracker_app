                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                AppIcon(
                                  icon: 'assets/vectors/category/${budgetEntity.category.iconName}',
                                  size: 36,
                                  iconSize: 24,
                          ...
                          Padding(
                            ...
                            child: BlocBuilder<TransactionBloc, TransactionState>(
                              builder: (context, state) {
                                final transactionByBudget = state.transactions.where((e) =>
                                    e.createdAt.isAfter(budgetEntity.startDate) &&
                                    e.createdAt.isBefore(budgetEntity.endDate) &&
                                    e.categoryId == budgetEntity.categoryId).toList();

                                final grouped = GroupTransactions.groupTransactionsByDate(transactionByBudget);
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        ...transactions.map(
                                            ...
                                            child: TransactionItem(transactionEntity: transaction, onTap: (){},),
                                          ),
                                        ),
                                      ],
                                    );
